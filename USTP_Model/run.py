...
def init_parser(config):
    ...
    parser.add_argument('--config_file', type=str,
                        default='config', help='the file name of config file')
...
def train(config, total = 5):
    ...
    for _i in range(total):
        ...
        logging.info('----------------------------------------------------------------------------')
        logging.info("# {}, Kownledge Graph Embedding: {}, Experiment ids: {}".format(_i, KGE, exp_id))
        logging.info('----------------------------------------------------------------------------')
        ...
        run_model(task=args.task, model_name=args.model, dataset_name=args.dataset,
                  config_file=args.config_file, other_args=other_args)
        # 获取指标
