...
def get_used_area_id():
    ...
    used_area = pd.read_csv('../raw_data/{0}Taxi{1}/{0}Taxi{1}.geo'
...
def get_used_road_id():
    # bike
    used_road = pd.read_csv('../raw_data/{0}Bike{1}/{0}Bike{1}.geo'
                            .format(dataset, "20190406" if dataset == "CHI" else "20200406"))
...
def get_used_POI_id():
    # human
    used_POI = pd.read_csv('../raw_data/{0}Human{1}/{0}Human{1}.geo'
                            .format(dataset, "20190406" if dataset == "CHI" else "20200406"))
