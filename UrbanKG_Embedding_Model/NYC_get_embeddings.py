...
model_path = "02_03/NYC/TransE_16_10_37/"
...
get_area_embeddings(KG_id_path_prefix + "NYC_used_area_KG_id.csv", entity_final_embedddings,
                      save_path_prefix + "NYC_area_embeddings.npy")

get_road_embeddings(KG_id_path_prefix + "NYC_used_road_KG_id.csv", entity_final_embedddings,
                      save_path_prefix + "NYC_road_embeddings.npy")

get_POI_embeddings(KG_id_path_prefix + "NYC_used_POI_KG_id.csv", entity_final_embedddings,
