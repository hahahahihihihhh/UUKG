...
def used_area_id2KG_id():
    used_area_id = pd.read_csv("used_xxx_id/NYC_used_area_id.csv")
    area_id2KG_id = pd.read_csv("xxx_id2KG_id/NYC_area_id2KG_id.csv")
    dict_area_id2KG_id = {}
    ...
    pd.DataFrame(data=used_area_id2KG_id, columns=['area_id', 'KG_id']).to_csv('used_xxx_id2KG_id/NYC_used_area_id2KG_id.csv', index=False)

def used_road_id2KG_id():
    used_road_id = pd.read_csv("used_xxx_id/NYC_used_road_id.csv")
    road_id2KG_id = pd.read_csv("xxx_id2KG_id/NYC_road_id2KG_id.csv")
    dict_road_id2KG_id = {}
    ...
    pd.DataFrame(data=used_road_id2KG_id, columns=['road_id', 'KG_id']).to_csv('used_xxx_id2KG_id/NYC_used_road_id2KG_id.csv', index=False)

def used_POI_id2KG_id():
    used_POI_id = pd.read_csv("used_xxx_id/NYC_used_POI_id.csv")
    POI_id2KG_id = pd.read_csv("xxx_id2KG_id/NYC_POI_id2KG_id.csv")
    dict_POI_id2KG_id = {}
    ...
    pd.DataFrame(data=used_POI_id2KG_id, columns=['POI_id', 'KG_id']).to_csv('used_xxx_id2KG_id/NYC_used_POI_id2KG_id.csv', index=False)
