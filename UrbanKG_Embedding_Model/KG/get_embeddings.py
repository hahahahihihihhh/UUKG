...
# model_path = "CHI/04_22/TransE_13_03_27"
model_path = "CHI/04_22/DisMult_14_08_41"
# model_path = "CHI/04_22/MuRE_09_28_51"

# model_path = "NYC/02_03/TransE_16_10_37"
...
if __name__ == "__main__":
    ...
    # load config file
    with open(os.path.join(LOG_PATH, model_path, "config.json")) as config:
        config = json.load(config)
        parser = init_parser(config)
        args = parser.parse_args()
    entity_final_embedddings = get_embeddings(os.path.join(LOG_PATH, model_path))
