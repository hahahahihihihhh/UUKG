...
if __name__ == "__main__":
    parser, model_path = init_parser(), "02_03/NYC/TransE_16_10_37/"
    ...
    get_area_embeddings(KG_id_path_prefix + "NYC_used_area_id2KG_id.csv", entity_final_embedddings,
                          save_path_prefix + "NYC_area_embeddings.npy")
    get_road_embeddings(KG_id_path_prefix + "NYC_used_road_id2KG_id.csv", entity_final_embedddings,
                          save_path_prefix + "NYC_road_embeddings.npy")
    get_POI_embeddings(KG_id_path_prefix + "NYC_used_POI_id2KG_id.csv", entity_final_embedddings,
                          save_path_prefix + "NYC_POI_embeddings.npy")
